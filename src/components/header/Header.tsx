                    ...
                    <div className="bg-secondary border-b border-primary mx-auto px-4 sm:px-6 lg:px-8 ">
                        <div className="flex items-center justify-between h-16">
                                        ...
                                        {({ open }) => (
                                            <>
                                                ...
                                                >
                                                    <Menu.Items
                                                        static
                                                        className="bg-secondary origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 ring-1 ring-neutralAlt ring-opacity-5 focus:outline-none"
                                                    >
                                                        {profile.map((item) => (
                                                            <Menu.Item
                                                                key={item}
                            ...
                            <div className="-mr-2 flex md:hidden">
                                {/* Mobile menu button */}
                                <Disclosure.Button className="bg-primarySoft inline-flex items-center justify-center p-2 rounded-md hover:text-primary hover:bg-neutralAlt focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-bg-neutralAlt focus:ring-bg-neutralAlt">
                                    <span className="sr-only">
                                        Open main menu
                                    </span>
                                    {open ? (
                    ...
                    <Disclosure.Panel className="md:hidden">
                        ...
                        <div className="pt-4 pb-3 border-t border-gray-700">
                            ...
                            <div className="mt-3 px-2 space-y-1">
                                <div className="block px-3 py-2 rounded-md text-base font-medium text-neutral transition-colors duration-200">
                                    <ThemeSwitcher />
                                </div>
                                {profile.map((item) => (
                                    <NavLink
